...
class Info extends Component{
    ...
    <div className="dui-info">
       ...
       <li id="info" className="list">Blood Alcohol Concentration (BAC) (This can be found on your arrest report.)</li>
    ...
    <div className="mission-text2">
      <p>After completing these requirements, you will receive a Certificate of Completion
